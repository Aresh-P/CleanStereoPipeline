...
def demo(args):
    ...
    with torch.no_grad():
        ...
        for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
            ...
            file_stem = os.path.join(output_directory, os.path.splitext(os.path.basename(imfile1))[0])
            ...
            out_img_pil.save(f"{file_stem}.png")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="dataset\\KITTI15\\training\\image_2\\*.png")
    parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="dataset\\KITTI15\\training\\image_3\\*.png")
